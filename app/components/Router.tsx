...
export function Router() {
    return (
        <div className="fixed z-20 h-full w-1/6 flex items-center group">
            ...
            <div className="w-16 bg-slate-400 p-4 gap-y-4 text-slate-600 text-3xl items-center justify-start shrink-0 h-2/3 tranform transition duration-300 ease-in-out -scale-50 -translate-x-28 rounded-2xl group-hover:translate-x-0 group-hover:scale-100 flex flex-col shadow-lg">
