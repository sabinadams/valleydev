    ...
    return (
        <div className="bg-slate-600 h-full relative">
            <div className="h-full w-full z-10 relative flex flex-col justify-center items-center gap-y-12 p-8 md:p-0">
                ...
                <p className="font-extrabold text-7xl text-white relative">
                    Valley Dev
                    <span className="rounded-2xl cursor-default select-none border-4 border-emerald-400 px-2 py-1 absolute z-10 right-[-4.3rem] text-emerald-400 text-sm font-semibold">Alpha</span>
                </p>
